...
C'était le `r format(as.Date(date_vol), "%d %B %Y")`. Je suis parti de la région de `r d_post[3]` à `r d_post[2]` et j'ai atterri dans la région de `r d_post[4]` pour un durée de vol de `r d_post[5]`. J'ai volé `r rmarkdown::metadata$vols` fois dans la journée avec Manu et Jean-Da.

Super déco, gros kiff.

Petite volte pas très propre (je dois faire ma phase vent arrière sans fioritures) qui m'a valu une remarque d'un instructeur. Mais ça va.
