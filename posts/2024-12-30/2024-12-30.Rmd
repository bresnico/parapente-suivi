---
title: "Joli vol depuis la Foilleuse avec Emmanuel"
...
C'était le `r format(as.Date(date_vol), "%d %B %Y")`. On est partis de la région de `r d_post[3]` à `r d_post[2]` et j'ai atterri dans la région de `r d_post[4]` pour un durée de vol de `r d_post[5]`. J'ai volé `r rmarkdown::metadata$vols` fois dans la journée. J'ai ressenti `r rmarkdown::metadata$intense` du `r rmarkdown::metadata$emotion`.

Il y avait Emmanuel, tout réalisé en transports en commun depuis les Ilettes, top !! On a tout bouclé entre 9h30 et 13h00.
...
https://www.livetrack24.com/track/2741206/view3d

```{=html}
<iframe 
    src="https://www.livetrack24.com/track/2741206/view3d" 
    width="100%" 
    height="600" 
    frameborder="0" 
    allowfullscreen>
