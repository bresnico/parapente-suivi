---
title: "Petit vol rapide et efficace"
...
C'était le `r format(as.Date(date_vol), "%d %B %Y")`. Je suis parti de la région des Cerniers à `r d_post[2]` et j'ai atterri dans la région de `r d_post[4]` pour un durée de vol de `r d_post[5]`. J'ai volé `r rmarkdown::metadata$vols` fois dans la journée.

C'était un petit vol très sympa avec Manu. 

Vert de printemps, ciel magnifique, super vent au déco.

On a pris le bus TPC de 9h20 au Vieux Pont. J'étais à 11h00 de retour à Vérossaz puis boulot en plaine. Parfait.
