...
C'était le `r format(as.Date(date_vol), "%d %B %Y")`. Je suis parti de la région de `r d_post[3]` à `r d_post[2]` et j'ai atterri dans la région de `r d_post[4]` pour un durée de vol de `r d_post[5]`. J'ai volé `r rmarkdown::metadata$vols` fois dans la journée avec Manu.

Laure m'a amené aux Cerniers. On y a attendu Manu qui montait en bus. Laure nous a poussés à Chindonne. On a fait un AR Chindonne - Valerette pour décoller sous l'auberge. Il y avait des nuages et du vent à Valerette.
