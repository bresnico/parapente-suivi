---
title: "joli vol avec petite menace de Foehn"
...
C'était le `r format(as.Date(date_vol), "%d %B %Y")`. Je suis parti de la région de la Foilleuse et j'ai atterri dans la région de `r d_post[4]` pour un durée de vol de `r d_post[5]`. J'ai volé `r rmarkdown::metadata$vols` fois dans la journée. C'est un vrai plaisir du début à la fin

Il y avait Manu. Comme d'habitude, on a pris la voiture électrique, on a marché, pris le train et le bus, puis le télécabine. On a bu un petit thé et un petit café. Tout était parfait.

Papa est venu me rechercher aux Ilettes pour aller manger à Chenarlier.
